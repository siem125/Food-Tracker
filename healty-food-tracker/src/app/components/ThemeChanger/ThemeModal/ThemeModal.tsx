...
import { useModal, ModalTypes } from '../../Modal/ModalContext/ModalContext'; // Import modal context
...
const ThemeModal: React.FC = () => {
  ...
  const openCustomThemeModal = () => {
    openModal(() => <ThemeCustomizerModal />, ModalTypes.SMALLBOX); // Opens custom theme modal
  };

  return (
    <div>
      <h2 style={{ color: 'green' }}>Select Theme</h2>
